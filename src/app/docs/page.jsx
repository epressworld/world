    ...
    <div className="space-y-8">
      ...
      <article className="rounded-xl border border-primary/35 bg-primary/10 p-6">
        ...
        <p className="mt-2 text-sm text-gray-200">
          If you want the shortest route: open Getting Started and run the
          Docker command.
        </p>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-5">
          ...
          <p className="mt-2 text-sm text-dark-muted">
            Start here for installation, runtime operations, and
            troubleshooting.
          </p>
        ...
        <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-5">
          <h2 className="text-xl font-semibold text-white">
            Need Protocol and Dev Details?
          </h2>
          <p className="mt-2 text-sm text-dark-muted">
            Architecture concepts, EWP protocol flows, and API references live
            in Developer Docs.
          </p>
          <div className="mt-4">
