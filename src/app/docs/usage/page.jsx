...
export default function UsagePage() {
  return (
    <div className="space-y-6">
      ...
      <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-6">
        <h2 className="text-xl font-semibold text-white">1. Complete First-Time Setup</h2>
        <p className="mt-2 text-gray-300">
          Open your node at <code className="rounded bg-dark-bg px-1.5 py-0.5 text-primary">http://localhost:8543</code> and
          finish the installation wizard.
        </p>
      </article>

      <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-6">
        <h2 className="text-xl font-semibold text-white">2. Configure Your Node Identity</h2>
      ...
      <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-6">
        <h2 className="text-xl font-semibold text-white">3. Publish Your First Content</h2>
        <ul className="mt-3 list-disc space-y-2 pl-6 text-gray-300">
          <li>Create content with Markdown editor.</li>
          <li>Upload files if needed (images, video, PDF, and others).</li>
          <li>Publish locally, then sign content when you want it circulated on the network.</li>
        </ul>
      </article>

      <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-6">
        <h2 className="text-xl font-semibold text-white">4. Connect and Follow Other Nodes</h2>
        <p className="mt-2 text-gray-300">
          Follow other epress nodes to establish social links and receive signed updates in your timeline.
        </p>
      </article>
      ...
      <div className="flex flex-wrap gap-3">
        <Link href="/docs/faq" className="btn-primary">Open FAQ</Link>
