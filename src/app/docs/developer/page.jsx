    ...
    <div className="space-y-6">
      <article className="rounded-2xl border border-dark-border bg-dark-surface/70 p-6 md:p-8">
        ...
        <p className="mt-3 leading-7 text-gray-300">
          Build on <span className="text-white">epress world</span> through the <span className="text-white">epress world protocol</span>,
          and build or contribute to <span className="text-white">epress node</span> software.
        </p>
        <div className="mt-4 inline-flex rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3 py-1 text-xs text-emerald-300">
          Implementation Status: Canonicalized against whitepaper and current node implementation
        </div>
      </article>

      <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-6">
        <h2 className="text-xl font-semibold text-white">Canonical Terminology</h2>
        <div className="mt-4 grid gap-4 md:grid-cols-3">
          <div className="rounded-lg border border-dark-border bg-dark-bg/60 p-4">
            ...
            <p className="mt-2 text-sm text-gray-300">The decentralized social network as a whole.</p>
          </div>
          <div className="rounded-lg border border-dark-border bg-dark-bg/60 p-4">
            <p className="text-sm font-semibold text-white">epress world protocol</p>
            <p className="mt-2 text-sm text-gray-300">The protocol layer used by nodes to interoperate.</p>
          </div>
          <div className="rounded-lg border border-dark-border bg-dark-bg/60 p-4">
            <p className="text-sm font-semibold text-white">epress node</p>
            <p className="mt-2 text-sm text-gray-300">The software implementation operated by node owners.</p>
          </div>
        </div>
      </article>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-5">
          ...
          <p className="mt-2 text-sm text-dark-muted">
            Understand protocol concepts, network flows, and integration endpoints.
          </p>
          <div className="mt-4">
        ...
        <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-5">
          <h2 className="text-xl font-semibold text-white">Build and contribute to epress node</h2>
          <p className="mt-2 text-sm text-dark-muted">
            Set up development, understand architecture, and use GraphQL and REST APIs.
          </p>
          <div className="mt-4">
