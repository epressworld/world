    ...
    <div className="space-y-6">
      <article className="rounded-2xl border border-dark-border bg-dark-surface/70 p-6 md:p-8">
        ...
        <p className="mt-3 leading-7 text-gray-300">
          The fastest way to launch epress node software is Docker. Run one
          command, open your browser, and complete the installation wizard.
        </p>
      </article>
      ...
      <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-6">
        ...
        <p className="mt-3 text-gray-300 leading-7">
          In this guide you operate epress node software. Once configured, your
          node participates in epress world and exchanges data with other nodes
          through the epress world protocol.
        </p>
      </article>
      ...
      <article className="rounded-xl border border-dark-border bg-dark-surface/70 p-6">
        ...
        <ol className="mt-3 list-decimal space-y-2 pl-6 text-gray-300">
          ...
          <li>
            Follow the wizard to initialize your node and finish first-time
            setup.
          </li>
        </ol>
      </article>
