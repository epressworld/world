  ...
  return (
    ...
    >
      ...
      <circle
        ...
        strokeWidth="2"
      />
      <text x="74" y="95" textAnchor="middle" fill="#bae6fd" fontSize="10">
        Person
      </text>
      ...
      <rect
        ...
        stroke="#3b3b3b"
      />
      <text x="208" y="81" textAnchor="middle" fill="#d4d4d8" fontSize="10">
        Centralized Platform
      </text>
      <rect x="172" y="92" width="72" height="20" rx="6" fill="#222" />
      <text x="208" y="106" textAnchor="middle" fill="#a1a1aa" fontSize="9">
        Account
      </text>
      <text x="170" y="146" fill="#71717a" fontSize="9">
        Identity depends on platform account
      </text>
    </svg>
  )
}
...
function NodeEraSvg() {
  return (
    ...
    >
      ...
      <text x="123" y="135" textAnchor="middle" fill="#fbbf24" fontSize="9">
        your-node.site
      </text>
      <circle
        cx="256"
        ...
        strokeWidth="2"
      />
      <text x="256" y="86" textAnchor="middle" fill="#fbbf24" fontSize="9">
        Your
      </text>
      <text x="256" y="100" textAnchor="middle" fill="#fbbf24" fontSize="9">
        Identity
      </text>
      <path d="M198 90 L226 90" stroke="#f7931a" strokeWidth="2" />
      <polygon points="226,90 216,84 216,96" fill="#f7931a" />
      <text x="56" y="159" fill="#71717a" fontSize="9">
        Self-hosted node becomes your social presence
      </text>
    </svg>
  )
}
  ...
  return (
    ...
    >
      ...
      <circle
        ...
        strokeWidth="2"
      />
      <text x="82" y="95" textAnchor="middle" fill="#93c5fd" fontSize="10">
        You
      </text>
      <rect
        x="134"
        ...
        stroke="#f7931a"
      />
      <text x="174" y="84" textAnchor="middle" fill="#fbbf24" fontSize="9">
        epress
      </text>
      <text x="174" y="98" textAnchor="middle" fill="#fbbf24" fontSize="9">
        Node
      </text>
      <rect
        x="244"
        ...
        stroke="#34d399"
      />
      <text x="276" y="67" textAnchor="middle" fill="#6ee7b7" fontSize="9">
        AI Agent
      </text>
      <rect
        x="244"
        ...
        stroke="#60a5fa"
      />
      <text x="276" y="119" textAnchor="middle" fill="#93c5fd" fontSize="9">
        APIs
      </text>
      ...
      <text x="38" y="159" fill="#71717a" fontSize="9">
        AI can operate your social interactions via open interfaces
      </text>
    </svg>
  )
}
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="relative py-32 text-center overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
              Your self-hosted epress node is your social agent inside epress
              world. It follows the epress world protocol to connect, store, and
              publish on the network, and plugs directly into your AI workflows.
            </p>
        ...
        <section
          id="why-agent"
          className="py-14 border-t border-dark-border bg-dark-surface/40"
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <article className="rounded-xl border border-dark-border bg-dark-bg/70 p-4">
                ...
                <p className="text-sm text-gray-400">
                  One person, one platform account. Identity is controlled by
                  the platform.
                </p>
              </article>
              <article className="rounded-xl border border-dark-border bg-dark-bg/70 p-4">
                ...
                <p className="text-sm text-gray-400">
                  One person, one self-hosted node. Identity and data are
                  controlled by you.
                </p>
              </article>
              <article className="rounded-xl border border-dark-border bg-dark-bg/70 p-4">
                ...
                <p className="text-sm text-gray-400">
                  Your node becomes a programmable social interface for your own
                  AI agent.
                </p>
              </article>
            </div>
        ...
        <section id="learn-more" className="py-20">
          <div className="container-custom">
            <h2 className="text-3xl font-bold text-center mb-4">
              What is epress world?
            </h2>
            <p className="text-lg text-gray-400 text-center max-w-3xl mx-auto mb-12">
              epress world is a decentralized social network where each
              participant runs an epress node. Nodes interoperate through the
              epress world protocol, so the network can run without centralized
              platform ownership. It keeps the ease of social publishing, but
              replaces platform trust with cryptographic proof.
            </p>
            ...
            <div className="mt-10 rounded-2xl border border-dark-border bg-dark-surface/70 p-6">
              ...
              <div className="rounded-xl border border-dark-border bg-dark-bg p-4 overflow-x-auto">
                <code className="text-primary text-sm break-all">
                  docker run -d -p 8543:8543 -p 8544:8544 -v
                  epress-data:/app/data --name my-epress-node
        ...
        <section id="core-concepts" className="py-20 bg-dark-surface">
          <div className="container-custom">
            ...
            <p className="text-gray-400 text-center mb-10 max-w-3xl mx-auto">
              Five mechanisms turn this idea into a working epress world
              network.
            </p>
            <ConceptSections />
          </div>
