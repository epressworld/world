...
const concepts = [
  {
    ...
    points: [
      "No username/password lock-in",
      "Portable and self-owned identity",
    ],
  },
  {
    id: "node",
  ...
  },
  {
    ...
    points: [
      "No unilateral follow records",
      "Both nodes store the same relationship",
    ],
  },
  {
    id: "content",
  ...
  return (
    ...
    >
      ...
      <circle
        ...
        strokeWidth="2"
      />
      <text x="106" y="92" textAnchor="middle" fill="#FBBF24" fontSize="12">
        You
      </text>
      <rect
        x="48"
        ...
        stroke="#393939"
      />
      <text x="106" y="154" textAnchor="middle" fill="#9CA3AF" fontSize="10">
        Private Key
      </text>
      <rect
        x="40"
        ...
        stroke="#3B82F6"
      />
      <text x="106" y="210" textAnchor="middle" fill="#93C5FD" fontSize="11">
        0x7a2...f9
      </text>
      ...
      <rect
        ...
        stroke="#F7931A"
      />
      <text x="298" y="84" textAnchor="middle" fill="#FBBF24" fontSize="11">
        Sign Message
      </text>
      <text x="298" y="104" textAnchor="middle" fill="#FDE68A" fontSize="10">
        SIWE / EIP-712
      </text>
      ...
      <rect
        ...
        stroke="#3f3f46"
      />
      <text x="476" y="70" textAnchor="middle" fill="#D4D4D8" fontSize="10">
        Node Auth
      </text>
      <circle cx="476" cy="108" r="20" fill="#10281a" stroke="#34D399" />
      <text x="476" y="114" textAnchor="middle" fill="#34D399" fontSize="16">
        ✓
      </text>
      ...
      <rect
        ...
        stroke="#2f2f2f"
      />
      <text x="244" y="198" fill="#A1A1AA" fontSize="10">
        What this means
      </text>
      <text x="244" y="220" fill="#E5E7EB" fontSize="11">
        Your identity is self-owned and verifiable.
      </text>
      <text x="244" y="238" fill="#E5E7EB" fontSize="11">
        No platform can freeze or revoke it.
      </text>
    </svg>
  )
}
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        stroke="#F7931A"
      />
      <text x="129" y="102" textAnchor="middle" fill="#FBBF24" fontSize="10">
        your-node.example
      </text>
      <rect
        x="44"
      ...
      <rect
        ...
        stroke="#353535"
      />
      <text x="457" y="80" textAnchor="middle" fill="#D4D4D8" fontSize="10">
        What your node stores
      </text>
      <rect
        x="402"
        y="96"
        ...
        stroke="#34D399"
      />
      <text x="457" y="117" textAnchor="middle" fill="#6EE7B7" fontSize="10">
        Your Content
      </text>
      <rect
        x="402"
        ...
        stroke="#60A5FA"
      />
      <text x="457" y="159" textAnchor="middle" fill="#93C5FD" fontSize="10">
        Connections
      </text>
      <rect
        x="402"
        ...
        stroke="#F7931A"
      />
      <text x="457" y="201" textAnchor="middle" fill="#FBBF24" fontSize="10">
        Profile & Config
      </text>
    </svg>
  )
  ...
  return (
    ...
    >
      ...
      <circle
        ...
        strokeWidth="2"
      />
      <text x="110" y="103" textAnchor="middle" fill="#FBBF24" fontSize="13">
        Alice
      </text>
      ...
      <circle
        ...
        strokeWidth="2"
      />
      <text x="450" y="103" textAnchor="middle" fill="#93C5FD" fontSize="13">
        Bob
      </text>
      ...
      <rect
        ...
        stroke="#F7931A"
      />
      <text x="280" y="75" textAnchor="middle" fill="#FBBF24" fontSize="10">
        Signed Follow Intent
      </text>
      ...
      <rect
        ...
        stroke="#343434"
      />
      <text x="167" y="202" textAnchor="middle" fill="#D4D4D8" fontSize="10">
        Alice Node
      </text>
      <text x="167" y="224" textAnchor="middle" fill="#6EE7B7" fontSize="11">
        I follow Bob ✓
      </text>
      ...
      <rect
        ...
        stroke="#343434"
      />
      <text x="393" y="202" textAnchor="middle" fill="#D4D4D8" fontSize="10">
        Bob Node
      </text>
      <text x="393" y="224" textAnchor="middle" fill="#6EE7B7" fontSize="11">
        Alice follows me ✓
      </text>
      ...
      <path
        ...
        strokeDasharray="4 4"
      />
      <text x="280" y="200" textAnchor="middle" fill="#34D399" fontSize="9">
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        stroke="#353535"
      />
      <text x="92" y="118" textAnchor="middle" fill="#D4D4D8" fontSize="10">
        Content
      </text>
      ...
      <rect
        ...
        stroke="#F7931A"
      />
      <text x="279" y="142" textAnchor="middle" fill="#FBBF24" fontSize="10">
        SoS
      </text>
      <text x="279" y="160" textAnchor="middle" fill="#FDE68A" fontSize="9">
        hash + publisher + time
      </text>
      ...
      <rect
        ...
        stroke="#34D399"
      />
      <text x="462" y="126" textAnchor="middle" fill="#6EE7B7" fontSize="10">
        Proof of Source
      </text>
      <text x="462" y="145" textAnchor="middle" fill="#6EE7B7" fontSize="9">
        SoS + signature
      </text>
      <circle cx="462" cy="170" r="16" fill="#10281a" stroke="#34D399" />
      <text x="462" y="176" textAnchor="middle" fill="#34D399" fontSize="14">
        ✓
      </text>
      ...
      <rect
        ...
        stroke="#303030"
      />
      <text x="46" y="253" fill="#E5E7EB" fontSize="10">
        Every signed post can be verified before it enters someone else&apos;s
        timeline.
      </text>
    </svg>
  )
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        stroke="#343434"
      />
      <text x="104" y="68" textAnchor="middle" fill="#D4D4D8" fontSize="10">
        Stored Locally
      </text>
      <rect
        x="42"
        ...
        stroke="#34D399"
      />
      <text x="104" y="103" textAnchor="middle" fill="#6EE7B7" fontSize="9">
        Your posts
      </text>
      <rect
        x="42"
        ...
        stroke="#60A5FA"
      />
      <text x="104" y="141" textAnchor="middle" fill="#93C5FD" fontSize="9">
        Followed content
      </text>
      <rect
        x="42"
        ...
        stroke="#F7931A"
      />
      <text x="104" y="179" textAnchor="middle" fill="#FBBF24" fontSize="9">
        Timestamps
      </text>
      ...
      <rect
        ...
        stroke="#F7931A"
      />
      <text x="385" y="90" textAnchor="middle" fill="#FBBF24" fontSize="10">
        Your Timeline (newest first)
      </text>

      <rect x="252" y="108" width="266" height="34" rx="8" fill="#202020" />
      <text x="266" y="129" fill="#E5E7EB" fontSize="10">
        12:08 Bob published a signed post
      </text>

      <rect x="252" y="148" width="266" height="34" rx="8" fill="#202020" />
      <text x="266" y="169" fill="#E5E7EB" fontSize="10">
        11:55 Your local draft was updated
      </text>

      <rect x="252" y="188" width="266" height="34" rx="8" fill="#202020" />
      <text x="266" y="209" fill="#E5E7EB" fontSize="10">
        11:26 Alice&apos;s content passed PoS check
      </text>
      ...
      <rect
        ...
        stroke="#ef4444"
      />
      <text x="482" y="36" textAnchor="middle" fill="#fca5a5" fontSize="9">
        No hidden feed ranking
      </text>
    </svg>
  )
}
